...
namespace ViniloVibes.Api.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartItems_Vinyls_VinylId",
                        column: x => x.VinylId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Ratings_Vinyls_VinylId",
                        column: x => x.VinylId,
                        principalTable: "Vinyls",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_UserId_VinylId",
                table: "CartItems",
                columns: new[] { "UserId", "VinylId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CartItems_VinylId",
                table: "CartItems",
                column: "VinylId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ratings_UserId_VinylId",
                table: "Ratings",
                columns: new[] { "UserId", "VinylId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Ratings_VinylId",
                table: "Ratings",
                column: "VinylId");
